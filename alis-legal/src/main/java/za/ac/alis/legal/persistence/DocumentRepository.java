...
import za.ac.alis.core.projections.DocumentInfoProjection;
import za.ac.alis.core.projections.MonthlyUploadProjection;
import static za.ac.alis.core.queries.AdminDashboardQueries.COUNT_ACTIVE_CLIENTS;
import static za.ac.alis.core.queries.AdminDashboardQueries.FIND_RECENT_DOCUMENTS;
import static za.ac.alis.core.queries.AdminDashboardQueries.MONTHLY_UPLOADS;
...
public interface DocumentRepository extends JpaRepository<Document, Long> {
    ...
    @Query("SELECT d FROM Document d JOIN FETCH d.client WHERE d.documentId = :documentId")
    Document findByIdWithClient(@Param("documentId") Long documentId);
