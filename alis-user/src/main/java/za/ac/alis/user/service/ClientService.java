...
@Service
@Transactional
public class ClientService implements UserRegistrationService {
    ...
    public Client registerClient(String fullName, String email, String password) {
        ...
        auditLogPort.logClientAction(saved, ActionType.USER_CREATED, "Client registered: " + email, "SYSTEM");
        return saved;
    }
    ...
    public DealMaker registerDealMaker(String fullName, String email, String password,
        ...
        auditLogPort.logClientAction(saved, ActionType.USER_CREATED, "DealMaker registered: " + email, "SYSTEM");
        return saved;
    }
    ...
    public LegalPractitioner registerLegalPractitioner(String fullName, String email, String password,
        ...
        auditLogPort.logClientAction(saved, ActionType.USER_CREATED, "Legal Practitioner registered: " + email, "SYSTEM");
        return saved;
    }
    ...
    public Client login(String email, String rawPassword) {
        ...
        if (!passwordEncoder.matches(rawPassword, client.getPasswordHash())) {
            auditLogPort.logClientAction(client, ActionType.LOGIN, "Failed login attempt for: " + email, "SYSTEM");
            throw new RuntimeException("Invalid credentials");
        }
        auditLogPort.logClientAction(client, ActionType.LOGIN, "Successful login: " + email, "SYSTEM");
        return client;
    }
    ...
    public Client updateOwnProfile(Long clientId, ClientProfileUpdateRequest request) {
        ...
        auditLogPort.logClientAction(saved, ActionType.USER_UPDATED,
    ...
    public void deleteOwnAccount(Long clientId) {
        Client existing = getClientById(clientId);
        documentCleanupPort.deleteAllDocumentsForClient(clientId);
        auditLogPort.deleteByClientId(clientId);
